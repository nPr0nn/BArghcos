...
uniform vec4 waterColor = vec4(0.04, 0.38, 0.88, 1.0);
uniform vec4 waterColor2 = vec4(0.04, 0.35, 0.78, 1.0);
uniform vec4 foamColor = vec4(0.8125, 0.9609, 0.9648, 1.0);

uniform float time;
uniform vec2 playerPos;
uniform vec2 resolution;
uniform float foamIntensity = 0.5; // New uniform for foam intensity
